...
namespace Ex03.GarageLogic
{
    public class VehicleProducer
    {
        ...
        public static void InitTiresAirPressure(Vehicle i_Vehicle, LinkedList<int> i_AirPressures)
        {
            ...
            {
                tire.Inflating(i_AirPressures.ElementAt(tireIndex));
                tireIndex++;
            }
        }
        ...
        {
            i_Vehicle.m_VehicleEngine.FillEnergyInEngine(i_EnergyToAdd);
            i_Vehicle.m_LeftEnergy = (i_Vehicle.m_VehicleEngine.m_currentEnergy / i_Vehicle.m_VehicleEngine.m_maxEnergy) * 100;
        }
        ...
        {
            Vehicle vehicleFound = s_ExistingVehicles.Find(vehicle => vehicle.m_LicenseNumber == i_LicenseNumber);
        ...
        {
            return s_ExistingVehicles.Exists(vehicle => vehicle.m_LicenseNumber == i_LicenseNumber);
        }
    }
}
